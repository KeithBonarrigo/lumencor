...
<head>
	...
	<?php wp_head(); ?>
	<!-- <link rel="stylesheet" id="bootstrap-fa-icon-css" href="/wp-content/plugins/easy-bootstrap-shortcodes/styles/font-awesome.min.css?ver=4.2.2" type="text/css" media="all"> -->
	<link rel="stylesheet" id="google-roboto-font" href="https://fonts.googleapis.com/css?family=Roboto:300|Roboto+Condensed|Roboto:400&subset=latin" type="text/css" media="all">
			...
			<?php endif; // true === $et_contact_info_defined ?>
				...
				?>
				 ...
				 <div id="et_top_search">
			      ...
			      <span><a href="/site-map" id="info-circle"></a></span>
			    <span><a href="/quote-request/" id="money-box"></a></span>
